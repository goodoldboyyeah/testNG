...
public class HttpUtilsCopy {
    ...
    public static Response sendGet1(Request request) {
        return sendGet(request, StandardCharsets.UTF_8.name());
    }

    public static Response sendGet(Request request, String contentType) {
